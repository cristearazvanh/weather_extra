...
To put in your custom.css
	...
	.compliments .wi-day-sunny {
	  content: url("../modules/default/weather/icons/clear.png");
	  transform: translate(0, 25px);
	}

	.ompliments .wi-day-cloudy {
	  content: url("../modules/default/weather/icons/mostlysunny.png");
	}

	.compliments .wi-cloudy {
	  content: url("../modules/default/weather/icons/cloudy.png");
	}

	.compliments .wi-day-cloudy-windy {
	  content: url("../modules/default/weather/icons/mostlycloudy.png");
	}

	.compliments .wi-day-showers {
	  content: url("../modules/default/weather/icons/rain.png");
	}
	...
	.compliments .wi-day-thunderstorm {
	  content: url("../modules/default/weather/icons/tstorms.png");
	}

	.compliments .wi-day-snow {
	  content: url("../modules/default/weather/icons/snow.png");
	}

	.compliments .wi-day-fog {
	  content: url("../modules/default/weather/icons/fog.png");
	}

	.compliments .wi-night-clear {
	  content: url("../modules/default/weather/icons/nt_clear.png");
	  transform: translate(0, 25px) scale(1.2);
	}

	.compliments .wi-night-cloudy {
	  content: url("../modules/default/weather/icons/nt_cloudy.png");
	}
	...
	.compliments .wi-night-alt-showers {
	  content: url("../modules/default/weather/icons/nt_rain.png");
	}
	...
	.compliments .wi-night-alt-thunderstorm {
	  content: url("../modules/default/weather/icons/nt_tstorms.png");
	}

	.compliments .wi-night-alt-snow {
	  content: url("../modules/default/weather/icons/nt_snow.png");
	}

	.compliments .wi-night-alt-cloudy-windy {
	  content: url("../modules/default/weather/icons/nt_hazy.png");
	}
